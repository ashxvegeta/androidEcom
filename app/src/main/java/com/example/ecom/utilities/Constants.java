package com.example.ecom.utilities;


public class Constants {
    public static final String API_BASE_URL = "https://dodgerblue-stork-848749.hostingersite.com/api";
    ...
    public static final String GET_BANNERS_URL = API_BASE_URL + "/banners";
//
